...
const WhyUs: React.FC = () => {
  return (
    <section id="whyus" className="py-4 md:py-8 px-4 md:px-10 lg:px-20 bg-gray-900">
        <h2 className="text-[1.6rem] lg:text-4xl font-semibold mb-2 text-center text-white">
